...
- **TailwindCSS**: Utilized for the "Precision Forge" design language—a high-end, dark-mode aesthetic with glassmorphism and accent coloring.
- **Material Symbols**: Integrated for consistent, professional iconography.
- **Context API**: Global state management for active blueprints and generation tracking.

### **Backend (The Core Engine)**
- **Node.js + Express**: Providing a lightweight yet robust API layer.
- **Google Gemini 2.0 Flash**: Our AI engine, configured with a **Strict JSON Schema** to ensure zero-parse errors on the frontend.
- **SQLite3**: A persistent storage layer for project history, allowing founders to save and retrieve their forged blueprints.

---

## 🚀 Key Features

### 1. **Dynamic PRD Generation**
...
### 3. **Viability Instrumentation**
Real-time "Health Scores" and a 6-axis **Concept Radar** that analyzes Utility, Market Size, Defensibility, Monetization, Technical Risk, and Urgency.

### 4. **Persistent History**
A dedicated dashboard to browse through past generations, grouped by time, allowing for iterative refinement of ideas.
