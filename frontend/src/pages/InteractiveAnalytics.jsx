...
<div   className="bg-surface-container rounded-xl p-5 ghost-border flex flex-col relative overflow-hidden group hover:bg-surface-container-high transition-colors cursor-pointer" >
...
<div   className="bg-surface-container rounded-xl p-5 ghost-border flex flex-col relative group hover:bg-surface-container-high transition-colors cursor-pointer" >
<div className="flex flex-col justify-between h-[5.5rem]">
