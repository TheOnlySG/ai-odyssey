...
<path className="animate-draw" d="M0,80 C10,70 20,90 30,60 C40,30 50,50 60,40 C70,30 80,60 90,20 C95,10 100,20 100,20" fill="none" stroke="#7c3aed" strokeLinecap="round" strokeWidth="0.5"></path>
</svg>
{/* X Axis Labels */}
...
<div className="h-full bg-tertiary animate-grow" ></div>
</div>
...
<div className="flex-1 h-3 bg-surface-container-lowest rounded-full overflow-hidden">
<div className="h-full bg-secondary animate-grow" ></div>
</div>
...
<div className="flex-1 h-3 bg-surface-container-lowest rounded-full overflow-hidden">
<div className="h-full bg-[#f59e0b] animate-grow" ></div>
</div>
...
<div className="flex-1 h-3 bg-surface-container-lowest rounded-full overflow-hidden">
<div className="h-full bg-error animate-grow" ></div>
</div>
...
<span className="text-[#5a5a62]">© 2024 Origin. Precision Instrumentation.</span>
...
export default AnimatedAnalytics2;
